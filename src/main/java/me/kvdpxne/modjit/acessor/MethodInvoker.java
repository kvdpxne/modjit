 ...
 * invocation of methods, abstracting the underlying {@link java.lang.reflect.Method} object.
 * <p>
 * This interface provides methods to invoke a target method with or without parameters on a given object instance.
 * </p>
 *
...
public interface MethodInvoker {
   ...
   *   arguments, an empty array ({@code new Object[0]}) should be passed. Passing {@code null} will result in a single
   *   argument of {@code null} being passed to the method.
   ...
   * <p>
   * This is a convenience method equivalent to calling {@code invoke(target, null)} or
   * {@code invoke(target, new Object[0])}.
   * </p>
   *
   * @param target The object on which to invoke the method. For static methods, this parameter can be {@code null}.
   * @return The return value of the method invocation. If the method has a {@code void} return type, this will be
