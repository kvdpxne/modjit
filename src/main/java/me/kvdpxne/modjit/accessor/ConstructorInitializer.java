 ...
 * handle the invocation of constructors, abstracting the underlying {@link java.lang.reflect.Constructor} object.
 * <p>
 * This interface provides methods to create new instances with or without constructor parameters.
 * </p>
 *
...
public interface ConstructorInitializer {
   ...
   *   takes no arguments, an empty array or {@code null} can be passed.
   ...
   * <p>
   * This is a convenience method equivalent to calling {@code newInstance(null)} or
   * {@code newInstance(new Object[0])}.
   * </p>
   *
   * @return A new instance of the target class.
   * @throws me.kvdpxne.modjit.exception.ReflectionSecurityException if the underlying constructor is not accessible
